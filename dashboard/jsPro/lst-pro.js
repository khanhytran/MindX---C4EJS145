...
<td class="conProName" style="text-align: start;">${getArray[i].nameProduct}</td>
    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-left">${getArray[i].id}-${getArray[i].nameProduct}</h5>
        ...
        <div class="modal-body">
          <div class="modal-container">
              ...
              <div class="modal-con">
                <input type="text" value="${getArray[i].nameProduct}" class="modal-name${getArray[i].id}">
              </div>
          </div>
          <div class="modal-container">
...
function data(id) {
  let nameProduct = document.querySelector(`.modal-name${id}`).value
  ...
  let newItem = {...item, nameProduct, price, discound}
